...
ENV HELM_VERSION=v2.0.0-alpha.4
...
RUN wget https://github.com/kubernetes/helm/releases/download/${HELM_VERSION}/helm-${HELM_VERSION}-linux-amd64.tar.gz
RUN tar xzfv helm-${HELM_VERSION}-linux-amd64.tar.gz
