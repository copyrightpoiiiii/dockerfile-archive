...
RUN sed -i -e 's,main *$,main contrib non-free,g' /etc/apt/sources.list.d/neurodebian.sources.list; sed -i -e 's,universe *$,universe multiverse,g' /etc/apt/sources.list
