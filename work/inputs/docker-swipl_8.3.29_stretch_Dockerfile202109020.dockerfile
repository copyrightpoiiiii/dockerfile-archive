...
RUN set -eux; \
    SWIPL_VER=8.3.29; \
    SWIPL_CHECKSUM=4e15d8bde2d9da4fd504e17e10cbd7a7c3a77104972f10772396bad5015a9ee0; \
    ...
    # Hack to make build docs work without xpce
    touch swipl-$SWIPL_VER/man/pl2xpce; \
   ...
   -G Ninja \
    ...
    install_addin rserve_client https://github.com/JanWielemaker/rserve_client.git f8e83a4e1e4600baef4222dc4c2904a41a79a5ad; \
