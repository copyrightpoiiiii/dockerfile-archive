...
# https://julialang-s3.julialang.org/bin/checksums/julia-1.8.1.sha256
 ...
 case "$arch" in \
  'x86_64') \
   url='https://julialang-s3.julialang.org/bin/musl/x64/1.8/julia-1.8.1-musl-x86_64.tar.gz'; \
   sha256='d459b1283401a51219d619ecb053920be68b2331eb239e68c9c3a87a2388f4c4'; \
   ;; \
  *) \
