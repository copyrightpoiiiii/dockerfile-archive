...
RUN $url = 'https://downloads.python.org/pypy/pypy3.8-v7.3.7-win64.zip'; \
 Write-Host ('Downloading {0} ...' -f $url); \
 Invoke-WebRequest -Uri $url -OutFile 'pypy.zip'; \
 \
 $sha256 = '8ceb03d2f7b73c6ce0758290bc42ba366a45c46e033eda36f1779d957a905735'; \
 Write-Host ('Verifying sha256 ({0}) ...' -f $sha256); \
 ...
 \
 Write-Host 'Renaming ...'; \
 Rename-Item -Path C:\pypy3.8-v7.3.7-win64 -NewName C:\pypy; \
 \
