...
RUN sudo apt-get update \
    ...
    # TODO(rliaw) We use legacy resolver because autogluon.core was released and broke a bunch of builds.
    && $HOME/anaconda3/bin/pip --use-deprecated=legacy-resolver --no-cache-dir install -r requirements_tune.txt \
